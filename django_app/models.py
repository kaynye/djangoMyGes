...
class Evenement(models.Model):
    ...
    e_date_debut = models.DateTimeField(auto_now_add=True, verbose_name="date de debut")
    e_date_fin = models.DateTimeField(auto_now_add=True, verbose_name="date de fin")
